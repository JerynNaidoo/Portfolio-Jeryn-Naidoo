...
export const gridItems = [
  {
    id: 1,
    title: "I prioritize collaboration, fostering open communication, and teamwork ",
    description: "",
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "I constantly strive for improvement",
    className: "lg:col-span-1 md:col-span-3 md:row-span-1",
    imgClassName: "",
  ...
  {
    id: 5,
    title: "Currently completing a Udemy course on AI and Machine Learning",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Python Automated Essay Grading Model",
